...
public final class ServerLifecycleEvents {
	 ...
	 *
	 * <p>For example, an {OnlyIn(Dist.CLIENT) integrated server} will begin stopping, but its client may continue to run.
	 * Meanwhile, for a {OnlyIn(Dist.SERVER) dedicated server}, this will be the last event called.
	 */
