...
public final class BlockSetTypeRegistry {
	 ...
	 * @return a new {@link BlockSetType}
	 */
	public static BlockSetType register(ResourceLocation id, boolean canOpenByHand, SoundType soundType, SoundEvent doorClose, SoundEvent doorOpen, SoundEvent trapdoorClose, SoundEvent trapdoorOpen, SoundEvent pressurePlateClickOff, SoundEvent pressurePlateClickOn, SoundEvent buttonClickOff, SoundEvent buttonClickOn) {
